...
def sample_data() -> List[Dict[str, Union[int, str]]]:
    ...
    return [
        ...
        {"id": 2, "state": "PENDING", "date": "2023-12-03"},
        {"id": 3, "state": "EXECUTED", "date": "2023-11-30"},
        {"id": 4, "state": "EXECUTED", "date": "2023-12-02"},
        {"id": 5, "state": "CANCELED", "date": "2023-12-04"},
    ]
